    ...
    <form method="POST" action="{{ route('Movie.update', $movie) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('sutradara') is-invalid @enderror" id="sutradara"
                name="sutradara" value="{{ old('sutradara', $movie->sutradara) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('tahun_rilis') is-invalid @enderror" id="tahun_rilis"
                name="tahun_rilis" value="{{ old('tahun_rilis', $movie->tahun_rilis) }}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control @error('durasi') is-invalid @enderror" id="durasi"
                name="durasi" value="{{ old('durasi', $movie->durasi) }}">
        ...
        <a class="btn btn-warning" href="{{ route('Movie.index') }}" role="button">
            Cancel
        </a>
