    ...
    <form method="POST" action="{{ route('review.update', $review) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_pengguna') is-invalid @enderror" id="nama_pengguna"
                name="nama_pengguna" value="{{ old('nama_pengguna', $review->nama_pengguna) }}">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control @error('komentar') is-invalid @enderror" id="komentar" name="komentar" rows="3">{{ old('komentar', $review->komentar) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tanggal_review') is-invalid @enderror" id="tanggal_review"
                name="tanggal_review" value="{{ old('tanggal_review', $review->tanggal_review) }}">
            ...
            <select class="form-select @error('genre_id') is-invalid @enderror" id="genre_id" name="genre_id">
                ...
                @foreach ($genres as $genre)
                    <option value="{{ $genre->id }}"
                        {{ old('genre_id', $review->genre_id) == $genre->id ? 'selected' : '' }}>
                        {{ $genre->nama_genre }}
                    </option>
                @endforeach
